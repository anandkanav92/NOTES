...
The paper approximates the values of precision, recall and F1 score for each model using data manifolds. The study uses an intuitive way to calculate these metric efficiently. A new dataset is created(Toy dataset) with known probability distribution and euclidean distance is approximated to determine the quality of images generated by the model.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNTY2MTQ5MTksMTQ1MTQxOTk5OSwxMT
