...
Other experiment was done to evaluate the senstivity of the metric, FID, to mode dropping, encoding network used over four given datasets.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMyNDE5ODU0NSwxNDUxNDE5OTk5LDExNz
