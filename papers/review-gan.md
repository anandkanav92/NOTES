...
The paper approximates the values of precision, recall and F1 score for each model using data manifolds. The study uses an intuitive way to calculate these metric effecient
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyOTU0NTIyMDksMTQ1MTQxOTk5OSwxMT
