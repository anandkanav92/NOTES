...
# Design
This study evaluate each model using two experimental setups. The major difference lies in the choice of hyper-parameters.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1ODU4ODEyMjEsMTQ1MTQxOTk5OSwxMT
