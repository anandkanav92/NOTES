...
# Design
This paper uses FID (Fréchet Inception Distance), precision, recall and F1 score to evaluate the models. <metrics like log-likelihood, inception score
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NTI0MDg5MzAsNTgyNTIxNjI1LDM3OD
