...
- `calibrating the weight variance with 1/sqrt(n)` the variance increases with neuron count and thus it can be reduced to 1 by dividing each weight by sqrt(n), where n is the number of neurons. For ReLU, use  `w = np.random.randn(n) * sqrt 


> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMyNTEwMTM4OSw2MjAzODE1NjQsLTEyND
g0MjI5MzgsNDkyMzU2MTExLDU5NjgzMjI0Miw4NjE4ODkyOTAs
MTE2NjkxNjAzMSwtNzkyMTMwMTIzLC05NDg4NjMxOTgsOTI4Nj
cwNjUzLDEzMDUzMzQ1NzEsLTQzODE4OTgyNSwyMzU5ODAxNTUs
MjEwMzYxNDM4OV19
-->