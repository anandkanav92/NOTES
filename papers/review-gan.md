...
The paper approximates the values of precision, recall and F1 score for each model using data manifolds. The study uses an intuitive way to calculate these metric effeciently. A new dataset is created(Toy dataset) with known probability distribution and euclidean distance is 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTA1NTY5MTgwLDE0NTE0MTk5OTksMTE3Mj
